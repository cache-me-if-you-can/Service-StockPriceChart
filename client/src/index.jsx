      ...
      <div className="container">
        <div className="header">
          ...
          <a to="price-paid" className="tag" href="#">
            <span className="tag-icon">
              <svg width="16" height="16" viewBox="0 0 20 22"><g fillRule="evenodd"><ellipse cx="6" cy="3.5" rx="3.333" ry="3.5"></ellipse><path d="M4.224,8.4 L7.776,8.4 L7.776,8.4 C10.1088508,8.4 12,10.2911492 12,12.624 L12,14 L0,14 L0,12.624 L8.8817842e-16,12.624 C6.02486595e-16,10.2911492 1.89114922,8.4 4.224,8.4 Z"></path></g></svg>
            </span>
            <span className="inner-tag">
              {owner}
            </span>
